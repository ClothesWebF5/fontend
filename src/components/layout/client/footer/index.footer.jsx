        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">FASHION</h2>
          ...
          {/* Danh mục sản phẩm */}
          <div>
            <h2 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200">Danh mục</h2>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Thời trang nam</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Thời trang nữ</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Phụ kiện</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Giày dép</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Bộ sưu tập mới</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition flex items-center group"><ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 mr-0 group-hover:mr-2 text-blue-500" />Khuyến mãi</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 mb-6">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600 hover:text-gray-900 transition cursor-pointer">0123 456 789</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-6 w-6 mr-3 text-blue-600 flex-shrink-0 mt-1" />
                <span className="text-gray-600 hover:text-gray-900 transition cursor-pointer">duytrinhcong107@gmail.com</span>
              </li>
            </ul>
