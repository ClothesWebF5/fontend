        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">F5</h2>
          ...
          {/* Về F5 */}
          <div>
            <h2 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200">Về F5</h2>
          ...
          <div>
            ...
            <ul className="space-y-5 mb-6">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600 hover:text-gray-900 transition cursor-pointer">f5clothes@support.com</span>
              </li>
            </ul>
