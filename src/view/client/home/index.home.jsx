...
//         }, 3000); // Đổi sản phẩm mỗi 3 giây, giống Hero Banner
//         return () => clearInterval(interval);
...
//             <div className="relative overflow-hidden rounded-xl h-[500px] mb-16 shadow-xl group mt-24">
...
//                         <div
//                             key={index}
//                             className="w-full flex-shrink-0 h-[500px] flex relative bg-gradient-to-r from-pink-50 via-white to-pink-50"
//                         >
//                             {/* Decorative elements */}
...
//                             {/* TEXT SECTION */}
//                             <div className="w-1/2 flex flex-col justify-center pl-[100px] z-10">
//                                 <div className="relative mb-2 animate__animated animate__bounceInUp" style={{ animationDelay: '0.2s' }}>
//                                     <p className="text-sm font-medium text-pink-600 uppercase tracking-widest">
//                                         Just Dropped
//                                     </p>
//                                 </div>

//                                 <h2 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-6 animate__animated animate__bounceInUp" style={{ animationDelay: '0.3s' }}>
//                                     Elevate Your Style<br />
//                                     with Our <span className="text-pink-600">New Arrivals</span>
//                                 </h2>

//                                 <p className="text-gray-600 text-base mb-8 max-w-md animate__animated animate__bounceInUp" style={{ animationDelay: '0.4s' }}>
...
//                                 <div className="flex space-x-4 animate__animated animate__bounceInUp" style={{ animationDelay: '0.5s' }}>
//                                     <button className="bg-pink-500 hover:bg-pink-600 transition-all duration-300 text-white py-3 px-8 rounded-full text-sm font-semibold shadow-lg hover:shadow-pink-200 transform hover:-translate-y-1">
//                                         Shop Now
//                                     </button>
//                                     <button className="border-2 border-gray-800 hover:bg-gray-800 hover:text-white transition-all duration-300 text-gray-800 py-3 px-8 rounded-full text-sm font-semibold transform hover:-translate-y-1">
//                                         Explore Collection
//                                     </button>
//                                 </div>
//                             </div>

//                             {/* IMAGE SECTION - Cải tiến */}
//                             <div className="w-1/2 h-full flex items-center justify-center relative px-8">
//                                 {/* Background circle for depth */}
//                                 <div className="absolute w-80 h-80 rounded-full bg-gradient-to-tr from-pink-100 to-purple-100 shadow-xl"></div>
...
//                                     {/* Price tag badge */}
//                                     <div className="absolute -top-5 -right-5 bg-pink-500 text-white w-16 h-16 rounded-full flex items-center justify-center font-bold shadow-lg rotate-12">
//                                         <div className="text-center leading-tight text-xs">
//                                             <div>UP TO</div>
//                                             <div className="text-lg font-extrabold">40%</div>
//                                             <div>OFF</div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                         <button
//                             key={index}
//                             className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentSlide ? 'bg-pink-500 scale-125' : 'bg-gray-300'
//                                 }`}
...
//                 {/* Arrow Navigation */}
//                 <button
//                     className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-90 rounded-full p-2 text-pink-600 hover:text-pink-800 transition-all duration-300 opacity-0 group-hover:opacity-100 shadow-md"
//                     onClick={() =>
...
//                 <button
//                     className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-90 rounded-full p-2 text-pink-600 hover:text-pink-800 transition-all duration-300 opacity-0 group-hover:opacity-100 shadow-md"
//                     onClick={() =>
...
//                     {/* Sidebar */}
//                     <div className="col-span-1 sticky top-24 self-start space-y-8">
...
//                                         <div className="flex space-x-1 items-center text-yellow-400 text-xs my-1">
//                                             {[...Array(5)].map((_, i) => (
...
//                                             <span className="ml-2 text-xs text-gray-400 line-through">{product.oldPrice}</span>
//                                         </div>
//                                     </div>
//                                 </div>
//                             ))}
...
//                             <ProductSlider items={newArrivals} title="New Articals" itemsPerPage={3} />
//                             <ProductSlider items={newArrivals} title="New Articals" itemsPerPage={3} />
//                             <ProductSlider items={newArrivals} title="New Articals" itemsPerPage={3} />
...
//                                             <div
//                                                 key={index}
//                                                 className="w-full flex-shrink-0 flex flex-col md:flex-row bg-gradient-to-r from-pink-50 via-white to-pink-50"
//                                             >
//                                                 {/* Decorative elements */}
//                                                 <div className="absolute top-0 left-0 w-full h-full opacity-10">
//                                                     <div className="absolute top-12 left-12 w-32 h-32 rounded-full bg-pink-300"></div>
...
//                                                 {/* Product Image */}
//                                                 <div className="w-full md:w-2/5 p-8 flex items-center justify-center relative z-10">
//                                                     <div className="relative group">
//                                                         <img
//                                                             src={product.image}
//                                                             alt={product.name}
//                                                             className="h-64 object-contain transition-transform duration-500 transform group-hover:scale-105 drop-shadow-xl"
//                                                         />
...
//                                                 {/* Product Details */}
//                                                 <div className="w-full md:w-3/5 p-8 flex flex-col justify-center z-10">
...
//                                                         <span className="ml-3 text-lg text-gray-400 line-through">{product.oldPrice}</span>
//                                                     </div>
...
//                                                                 <span className="font-medium">HURRY UP! OFFER ENDS IN:</span>
//                                                             </div>

//                                                             <div className="flex space-x-3">
//                                                                 {Object.entries(timeLeft).map(([unit, value]) => (
//                                                                     <div key={unit} className="bg-gray-50 p-3 rounded-lg shadow-sm flex flex-col items-center flex-1">
//                                                                         <span className="text-xl font-bold text-gray-800">{String(value).padStart(2, '0')}</span>
//                                                                         <span className="text-xs font-medium text-gray-500 capitalize">{unit}</span>
//                                                                     </div>
//                                                                 ))}
//                                                             </div>
//                                                         </div>

//                                                         <button className="flex items-center justify-center bg-pink-500 hover:bg-pink-600 text-white py-3 px-6 rounded-lg font-medium transition duration-200 shadow-md transform hover:-translate-y-1">
...
//                         {/* New Products */}
//                         <div className="mb-12">
//                             <h2 className="font-semibold mb-6">New Products</h2>
