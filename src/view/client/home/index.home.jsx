                ...
                >
                    {heroImages.map((img, index) => {
                        const slideContent = [
                            ...
                            {
                                tagline: "Xu hướng mới 2025",
                                title: ["Phong cách hiện đại", "thời thượng"],
                                highlight: "dành cho bạn",
                                description: "Cập nhật ngay những mẫu thiết kế hot nhất năm 2025. Từ streetwear năng động đến business chic, tất cả đều có tại StyleHub với giá cả hợp lý nhất.",
                                        ...
                                        <div className="flex space-x-4 sm:space-x-8 items-center">
                                            ...
                                            <div className="w-16 sm:w-28 h-16 sm:h-28 bg-white rounded-full flex items-center justify-center shadow-xl border-4 border-pink-200">
                                                <div className="text-center">
                                                    <div className="text-lg sm:text-3xl font-bold text-pink-600">F5</div>
                                                    <div className="text-xs sm:text-sm text-gray-600">CLOTHES</div>
                                                </div>
                                            </div>
