...
// import { getProducts } from "../../../services/common/common.service.jsx";
...
//     const slug = slugify(filter.searchKey || "", {
//       lower: true,
//       strict: true,
//       locale: "vi"
//     });
//     filter.searchKey = slug;
//     const res = await filterProduct(filter);
//     if (res.status === 200) {
...
//             onChange={handleFilter}
//             name="categoryId"
//             value={filter.categoryId} // Sử dụng value để xác định mục được chọn
//             className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
//           >
...
//           <select
//             onChange={handleFilter}
//             name="status" className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
//             <option value="">⚙️ Tất cả trạng thái</option>
//             <option value="active" className="text-green-500">Đang hoạt động</option>
//             <option value="inactive" className="text-red-500">Dừng hoạt động</option>
//           </select>
//         </div>
...
//                       <img src={p.src} alt={p.name} className="w-14 h-14 object-cover rounded-md" />
//                     </td>
//                     <td className="px-4 py-3 font-medium">{p.name}</td>
//                     <td className="px-4 py-3">{p.category?.name || "aaaa"}</td>
//                     <td className="px-4 py-3 text-center">2</td>
//                     <td className="px-4 py-3 text-center">
//                       <button onClick={() => handleViewPromotions(p)} className="text-blue-500 hover:underline text-sm">Xem khuyến mại</button>
//                     </td>
//                     <td className="px-4 py-3 text-center">{p.quantity}</td>
//                     <td className="px-4 py-3 text-center">
//                       {p.deleted ? <span className="text-red-500">Dừng hoạt động</span> : <span className="text-green-600">Đang hoạt động</span>}
//                     </td>
//                     <td className="px-4 py-3 text-center space-x-2">
//                       <button onClick={() => onEdit(p.product_id)} className="p-1.5 bg-blue-500 text-white rounded-full hover:bg-blue-600">
//                         <Pencil size={16} />
//                       </button>
//                       <button
//                         onClick={() => {
...
//                   >
//                     <button
//                       className="flex items-center gap-1 bg-red-500 text-white text-sm px-3 py-1.5 rounded-full shadow hover:bg-red-600"
//                     >
//                       <Trash2 size={16} />
//                       <span>Xóa</span>
//                     </button>
...
//                   <p className="text-sm text-gray-500 mb-1">{p.category?.name || "Danh mục không rõ"}</p>
