...
//                      <button
//                         onClick={() => navigate("/")}
//                         className="mb-4 flex items-center gap-1 text-sm text-green-400 hover:text-green-300 transition-colors duration-200 group"
//                     >
//                         <FontAwesomeIcon icon={faArrowLeft} className="text-xs group-hover:-translate-x-1 transition-transform duration-300" />
//                         <span className="hover:underline">Quay lại trang chủ</span>
//                     </button>
//                 </div>
//             </div>
